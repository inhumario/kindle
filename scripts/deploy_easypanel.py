#!/usr/bin/env python3
"""
Provisión / redeploy del servicio EasyPanel `travelia/kindle`.

Uso:
  python3 scripts/deploy_easypanel.py          # asegura build+env+dominio y despliega
  python3 scripts/deploy_easypanel.py deploy   # solo redeploy (tras un push a main)

Lee el token de ~/.config/aromas/easypanel.env y los secretos de Infisical
(carpeta `kindle`). El push a main NO redespliega: hay que ejecutar esto.
"""
...
PROJECT, SERVICE = "travelia", "kindle"
HOST = "kindle.inhumario.com"
